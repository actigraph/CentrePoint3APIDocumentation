...
|**nonFilteredVectorMagnitudeCounts**|Number|A  daily aggregate of the Vector Magnitude values (of x, y, and x axis counts) from the non-partial epochs for subject including non-wear AND sleep minutes|
|**wearFilteredVectorMagnitudeCounts**|Number|A  daily aggregate of the Vector Magnitude values (of x, y, and x axis counts) from the non-partial epochs for subject excluding non-wear minutes|
|**wearAwakeFilteredVectorMagnitudeCounts**|Number|A  daily aggregate of the Vector Magnitude values (of x, y, and x axis counts) from the non-partial epochs for subject excluding non-wear AND sleep minutes|
